            ...
            html: `
                <div style="max-width: 600px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
                    ...
                    <div style="padding: 20px 0;">
                        ...
                        <p style="font-size: 16px; margin-bottom: 20px; font-weight: bold;">Félicitations, votre compte a été créé avec succès !</p>
                        
                        <p style="font-size: 16px; margin-bottom: 20px;">
                            Vous faites maintenant partie de la communauté KADEEL, où acheter, vendre ou proposer vos services se fait simplement, rapidement et en toute confiance.
                        </p>
                        
                        <p style="font-size: 16px; margin-bottom: 20px;">Nous sommes ravis de vous compter parmi nous.</p>
                        
                        <p style="font-size: 16px; margin-bottom: 30px;">
                            Vous pouvez dès maintenant publier votre première annonce ou explorer les offres disponibles près de chez vous.
                        </p>
                        
                        <div style="text-align: center; margin: 30px 0;">
                            <a href="${process.env.FRONTEND_URL}" style="display: inline-block; padding: 15px 30px; background-color: #71A1A4; color: white; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; box-shadow: 0 3px 6px rgba(0,0,0,0.1); transition: background-color 0.3s;">Accéder à la plateforme KADEEL</a>
                        </div>
                        
                        <p style="font-size: 16px; margin: 30px 0 20px 0;">
                            Vous êtes également invité(e) à découvrir <strong>KADEEL Jobs</strong>, notre service de placement pour celles et ceux à la recherche d'un emploi ou d'un profil à recruter.
                        </p>
                        
                        <p style="font-size: 16px; margin-bottom: 10px;">
                            Si vous avez des questions, notre équipe reste disponible à l'adresse :
                        </p>
                        <p style="font-size: 16px; margin-bottom: 30px; font-weight: bold; color: #71A1A4;">
                            contact@kadeel.com
                        </p>
                        
                        <p style="font-size: 16px; margin-bottom: 20px;">Merci de faire partie de la communauté Kadeel !</p>
                        
                        <p style="font-size: 16px; margin-bottom: 30px;">L'aventure ne fait que commencer 🚀</p>
                        
                        <p style="font-size: 16px; margin-bottom: 0;">— L'équipe KADEEL</p>
                    </div>
                </div>
            `
        });
